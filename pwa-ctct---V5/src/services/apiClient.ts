...
const normalizeLegacyUser = (raw: any) => {
  ...
  return {
    ...
    organizationId: raw?.organizationId || raw?.OrganizationID || raw?.orgId || undefined,
    organizationName: raw?.organizationName || raw?.OrganizationName || raw?.canonicalOrganizationName || undefined,
    organizationPath: raw?.organizationPath || raw?.OrganizationPath || undefined,
    scopeLevel: raw?.scopeLevel || raw?.ScopeLevel || undefined,
